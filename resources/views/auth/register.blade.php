...
<head>
    ...
    <title>Aplikasi Karcis - Register</title>
...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5" style="width: 500px; margin-left:275px; top:50px;">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form action="{{ route('daftar') }}" method="POST" class="user">
                                @csrf
